...
/*
WellKnownApiService OIDC discovery information if OIDC auth is enabled
OIDC Discovery page, redirects to the token issuer if one is configured
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return OpenIDConfiguration
*/
func (a *WellKnownApiService) WellKnownOpenidConfigurationGet(ctx context.Context) (OpenIDConfiguration, *http.Response, error) {
	var (
