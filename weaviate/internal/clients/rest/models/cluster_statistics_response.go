...
// Validate validates this cluster statistics response
...
func (m *ClusterStatisticsResponse) validateStatistics(formats strfmt.Registry) error {
...
func (m *ClusterStatisticsResponse) UnmarshalBinary(b []byte) error {
	var res ClusterStatisticsResponse
