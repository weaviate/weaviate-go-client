...
var backupCreateResponseTypeStatusPropEnum []any
...
const (
	...
	// BackupCreateResponseStatusCANCELED captures enum value "CANCELED"
	BackupCreateResponseStatusCANCELED string = "CANCELED"
)
