...
import (
	...
	"github.com/weaviate/weaviate-go-client/v6/weaviate/internal/clients/rest/models"
)
...
func (o *ApplyReplicationScalePlanReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 501:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /replication/scale] applyReplicationScalePlan", response, response.Code())
	}
}
...
func (o *ApplyReplicationScalePlanOK) Error() string {
	...
	return fmt.Sprintf("[POST /replication/scale][%d] applyReplicationScalePlanOK %s", 200, payload)
}
...
func (o *ApplyReplicationScalePlanBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /replication/scale][%d] applyReplicationScalePlanBadRequest %s", 400, payload)
}
...
func (o *ApplyReplicationScalePlanForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /replication/scale][%d] applyReplicationScalePlanForbidden %s", 403, payload)
}
...
func (o *ApplyReplicationScalePlanNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /replication/scale][%d] applyReplicationScalePlanNotFound %s", 404, payload)
}
...
func (o *ApplyReplicationScalePlanInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /replication/scale][%d] applyReplicationScalePlanInternalServerError %s", 500, payload)
}
...
func (o *ApplyReplicationScalePlanNotImplemented) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /replication/scale][%d] applyReplicationScalePlanNotImplemented %s", 501, payload)
}
