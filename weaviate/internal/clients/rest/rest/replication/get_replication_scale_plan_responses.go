...
func (o *GetReplicationScalePlanReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 501:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /replication/scale] getReplicationScalePlan", response, response.Code())
	}
}
...
func (o *GetReplicationScalePlanOK) Error() string {
	...
	return fmt.Sprintf("[GET /replication/scale][%d] getReplicationScalePlanOK %s", 200, payload)
}
...
func (o *GetReplicationScalePlanBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /replication/scale][%d] getReplicationScalePlanBadRequest %s", 400, payload)
}
...
func (o *GetReplicationScalePlanForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /replication/scale][%d] getReplicationScalePlanForbidden %s", 403, payload)
}
...
func (o *GetReplicationScalePlanNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /replication/scale][%d] getReplicationScalePlanNotFound %s", 404, payload)
}
...
func (o *GetReplicationScalePlanInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /replication/scale][%d] getReplicationScalePlanInternalServerError %s", 500, payload)
}
...
func (o *GetReplicationScalePlanNotImplemented) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /replication/scale][%d] getReplicationScalePlanNotImplemented %s", 501, payload)
}
