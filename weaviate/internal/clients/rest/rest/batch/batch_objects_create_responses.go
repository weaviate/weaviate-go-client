...
func (o *BatchObjectsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
var batchObjectsCreateBodyFieldsItemsEnum []any
