...
func TestQueryBuilder(t *testing.T) {
	...
	t.Run("Simple Get", func(t *testing.T) {
		...
		query := builder.AddQueryClass(NewQueryClassBuilder("Pizza").WithFields(name)).build()
	...
	t.Run("Multiple fields", func(t *testing.T) {
		...
		query := builder.AddQueryClass(NewQueryClassBuilder("Pizza").WithFields(fields...)).build()
	...
	t.Run("Where filter", func(t *testing.T) {
		...
		query := builder.AddQueryClass(
			NewQueryClassBuilder("Pizza").
				WithFields(name).
				WithWhere(where),
		).build()
	...
	t.Run("Limit Get", func(t *testing.T) {
		...
		name := Field{Name: "name"}
		query := builder.AddQueryClass(NewQueryClassBuilder("Pizza").WithFields(name).WithLimit(2)).build()
	...
	t.Run("Limit And Offset Get", func(t *testing.T) {
		...
		query := builder.AddQueryClass(NewQueryClassBuilder("Pizza").WithFields(name).WithOffset(0).WithLimit(2)).build()
	...
	t.Run("NearText filter", func(t *testing.T) {
		...
		query := builder.AddQueryClass(NewQueryClassBuilder("Pizza").WithFields(name).WithNearText(nearText)).build()
	...
	t.Run("NearText filter with movers", func(t *testing.T) {
		...
		nearText = nearText.WithConcepts([]string{"good"})
		query := builder.AddQueryClass(NewQueryClassBuilder("Pizza").
			WithFields(name).
	...
	t.Run("NearVector filter", func(t *testing.T) {
		...
		query := builder.AddQueryClass(NewQueryClassBuilder("Pizza").WithFields(name).WithNearVector(nearVector)).build()
	...
	t.Run("Group filter", func(t *testing.T) {
		...
		query := builder.AddQueryClass(NewQueryClassBuilder("Pizza").WithFields(name).WithGroup(group)).build()
	...
	t.Run("Sort Get", func(t *testing.T) {
		...
		query := builder.AddQueryClass(NewQueryClassBuilder("Pizza").WithFields(name).WithSort(byProperty)).build()
		...
		query = builder.AddQueryClass(NewQueryClassBuilder("Pizza").WithFields(name).WithSort(byProperty1, byProperty2Desc)).build()
		expected = "{Get {Pizza (sort:[{path:[\"property1\"]}, {path:[\"property2\"] order:desc}]) {name}}}"
		assert.Equal(t, expected, query)

		byProperty3Asc := Sort{Path: []string{"property3"}, Order: Asc}
		query = builder.AddQueryClass(NewQueryClassBuilder("Pizza").WithFields(name).WithSort(byProperty1, byProperty2Desc, byProperty3Asc)).build()
...
func TestBM25Builder(t *testing.T) {
	...
	query := builder.AddQueryClass(NewQueryClassBuilder("Pizza").WithBM25(bm25B)).build()
...
func TestHybridBuilder(t *testing.T) {
	...
	query := builder.AddQueryClass(NewQueryClassBuilder("Pizza").WithHybrid(hybrid)).build()
