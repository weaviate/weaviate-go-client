...
where `v5.x.x` is the desired Go client `v5` version, for example `v5.2.1`.

Add dependency to your `go.mod`:

```go
require github.com/weaviate/weaviate-go-client/v5 v5.2.1
```
...
- [Documentation](docs.weaviate.io/weaviate/client-libraries/go).
