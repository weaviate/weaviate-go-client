...
type Hybrid struct {
	...
	Selection     *Selection `protobuf:"bytes,14,opt,name=selection,proto3,oneof" json:"selection,omitempty"`
...
const file_v1_base_search_proto_rawDesc = "" +
	...
	"\x0fuse_alpha_param\x18\r \x01(\bR\ruseAlphaParam\x129\n" +
	"\tselection\x18\x0e \x01(\v2\x16.weaviate.v1.SelectionH\x03R\tselection\x88\x01\x01\x12)\n" +
