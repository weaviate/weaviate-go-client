...
func TestBatch_integration(t *testing.T) {
	...
	t.Run("POST /batching/{type}", func(t *testing.T) {
		...
		objectT1, objErrT1 := client.Data.ThingGetter().WithID("abefd256-8574-442b-9293-9205193737ee").Do(context.Background())
		assert.Nil(t, objErrT1)
		assert.NotNil(t, objectT1)
		objectT2, objErrT2 := client.Data.ThingGetter().WithID("97fa5147-bdad-4d74-9a81-f8babc811b09",).Do(context.Background())
		assert.Nil(t, objErrT2)
		assert.NotNil(t, objectT2)
		objectA1, objErrA1 := client.Data.ActionGetter().WithID("565da3b6-60b3-40e5-ba21-e6bfe5dbba91").Do(context.Background())
		assert.Nil(t, objErrA1)
		assert.NotNil(t, objectA1)
		objectA2, objErrA2 := client.Data.ActionGetter().WithID("07473b34-0ab2-4120-882d-303d9e13f7af").Do(context.Background())
