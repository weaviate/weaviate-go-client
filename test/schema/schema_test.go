...
func TestSchema_errors(t *testing.T) {
	...
	t.Run("Fail to add property having not supported tokenization", func(t *testing.T) {
		...
		assert.EqualError(t, err, `status code: 422, error: {"code":606,"message":"tokenization in body should be one of [word lowercase whitespace field trigram gse kagome_kr kagome_ja gse_ch]"}`)
