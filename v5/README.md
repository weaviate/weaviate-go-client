...
```bash
$ go get github.com/semi-technologies/weaviate-go-client/v5@v5.x.x
```
...
```go
require github.com/semi-technologies/weaviate-go-client/v5 v5.0.0
```
...
import (
  ...
  client "github.com/semi-technologies/weaviate-go-client/v5/weaviate"
)
